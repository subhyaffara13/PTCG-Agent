...
from agents.forward_model_gen import _remove_from_hand, _int_or_str, _apply_evolve, _draw_cards
from agents.forward_model import _ABILITY_DRAW
...
def _resolve_base(gs: dict, hand: list, action: str) -> None:
    ...
    if act_type == "pass":
        ...
        from agents.forward_model_resolve_helpers import handle_retreat_helper
        handle_retreat_helper(gs, target, CardRegistry)

    elif act_type == "attack":
        from agents.forward_model_resolve_helpers import handle_attack_helper
        handle_attack_helper(gs, hand, CardRegistry)

    elif act_type == "play_trainer":
        from agents.forward_model_resolve_helpers import handle_play_trainer_helper
