...
class OrchestratorRunMixin:
    def _project_opponent_damage(self, game_state) -> int:
        from agents.orchestrator_run_helpers import project_opponent_damage_helper
        return project_opponent_damage_helper(game_state)

    def _check_defensive_retreat(self, game_state, board_summary) -> str:
        from agents.orchestrator_run_helpers import check_defensive_retreat_helper
    ...
    def execute_orchestrator_turn(self, game_state) -> str:
        ...
        from agents.orchestrator_run_helpers import update_opponent_model_helper
        ...
        from agents.orchestrator_run_helpers import check_lethal_helper
        ...
        from agents.orchestrator_run_helpers import handle_time_manager_helper
